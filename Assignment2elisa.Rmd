...
AQUEST ERA EL MODEL QUE HAVIEM CONSIDERAT INICIALMENT (ELIMINAR QUAN HO LLEGIS)
```{r}
...
For us, this means they will stay in our company after training --> stay
0 = candidate is NOT looking for a new job (likely to not come to our company after the training)
For us, this means they will leave our company after training to stay in their current job --> leave
...
*Candidates with more training hours are less likely to join our company after training, and therefore more likely to leave us and stay with their current employer.* (LAIA ESTA PART ES LA QUE EM SEMBLAVA RARO MIRA SI TÉ SENTIT O NO)
...
All else being equal (ceteris paribus), candidates without relevant experience have lower odds of staying compared to those with relevant experience, as indicated by the negative coefficient for relevent_experienceNo (β = −0.265). 
