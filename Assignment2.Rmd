...
llrem <- which( rownames(dftrain) %in% c("17113","10402"));llrem 
...
llrem <- which( rownames(dftrain) %in% c("944","3473"));llrem
dftrain <- dftrain[-llrem,]
```
```{r}
...
llrem <- which( rownames(dftrain) %in% c("11187","14820","4615","5968"));llrem
dftrain <- dftrain[-llrem,]
```
```{r}
